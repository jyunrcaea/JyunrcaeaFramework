...
namespace Jyunrcaea.Design
{
    ...
    /// 호버링 기능이 존재하는 평범한 버튼
    /// </summary>
    public class Button : Group, Events.MouseMove, Events.MouseKeyDown, Events.MouseKeyUp, DetailOfObject.Size
    {
        ...
        public int TextHeight
        {
            ...
            set
            {
                this.hoverbox.Size.Height = (th = value) + mg * 2;
            }
        }
        public int Width
        {
        ...
        public Button(string content,int width=0,int height=0,int? margin = null)
        {
